...
/*
 * Success screen. J.A.R.V.I.S. AGENT wordmark stays as the visual anchor
 ...
 * J.A.R.V.I.S..exe doesn't exist). We catch the Tauri error and surface it
  ...
  return (
    <div className="jarvis-fade-in flex h-full flex-col items-center justify-center gap-8 px-12 py-10">
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          <span>
            <span>J.A.R.V.I.S. is ready</span>
          </span>
          <span aria-hidden="true">J.A.R.V.I.S. is ready</span>
        </p>

        <p className="m-0 text-center text-base leading-normal tracking-tight text-muted-foreground">
          You can launch from here, or any time from your terminal with{' '}
          <code className="font-mono text-sm text-foreground/80">jarvis desktop</code>.
        </p>
      </div>
