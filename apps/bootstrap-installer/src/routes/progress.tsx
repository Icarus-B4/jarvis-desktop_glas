...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating J.A.R.V.I.S.' : 'Setting up J.A.R.V.I.S. Agent'

  const description = isUpdate
    ? 'J.A.R.V.I.S. is updating to the latest version — this only takes a moment.'
