 ...
 *   - J.A.R.V.I.S. AGENT wordmark rendered in Collapse Bold, uppercase, tracked
 ...
 * 99% of users; the rest will use the CLI installer with a -J.A.R.V.I.S.Home
  ...
  return (
    <div className="jarvis-fade-in flex h-full flex-col items-center justify-center gap-10 px-12 py-10">
      ...
      <div className="w-full max-w-2xl min-w-0 text-center">
        ...
        >
          <span>
            <span>J.A.R.V.I.S. AGENT</span>
          </span>
          <span aria-hidden="true">J.A.R.V.I.S. AGENT</span>
        </p>
