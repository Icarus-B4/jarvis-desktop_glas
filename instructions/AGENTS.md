...
How to build Jarvis Desktop well. This is a judgment guide, not an inventory —
...
- The **backend** is authoritative for anything another Jarvis surface can also
...
its shape. "Plugin" means several unrelated things across Jarvis — do not assume
